...
class JuryDrawer extends StatelessWidget {
  final String currentPage;

  JuryDrawer({this.currentPage});
          ...
          child: ListView(
            ...
            children: [
              DrawerTile(
                  icon: Icons.home,
                  onTap: () {
                    if (currentPage != "juryHome")
                      Navigator.pushReplacementNamed(context, '/juryHome');
                  },
                  iconColor: ArgonColors.primary,
                  title: "Home",
                  isSelected: currentPage == "juryHome" ? true : false),
              DrawerTile(
